...
"""
TCP module for client-server communication.

Provides TCP client manager, server manager, logging handler, and low-level
TCP node for bidirectional communication.
"""
